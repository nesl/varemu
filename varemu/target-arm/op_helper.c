...
#ifdef VEMU
void HELPER(vemu_info)(uint64_t val)
{
    TranslationBlock * tb;
...
void HELPER(vemu_error_replace)(uint64_t val)
{
    TranslationBlock * tb;
    tb = (TranslationBlock *)val;
    vemu_error_replace(env, tb);
}

void HELPER(vemu_error_pre)(uint64_t val)
{
    TranslationBlock * tb;
    tb = (TranslationBlock *)val;
...
void HELPER(vemu_error_post)(uint64_t val)
{
    TranslationBlock * tb;
    tb = (TranslationBlock *)val;
